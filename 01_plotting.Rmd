...
Here we exclude rates above 2 since those are low popluation places where a single accident would yield a high rate.
...
Generally it looks like the higher the crash rate, the more injuries - which might be expected. But again, there looks to be many places with higher than expected injuries vs. their rate.