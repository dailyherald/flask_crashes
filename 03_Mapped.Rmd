...
We examined the data geographically in a variety of ways. We mapped total crashes by year and crashes with injuries by year.
...
Then we started generating maps. 
...
This shows the break points in our data for quintiles. Each chunk is about 20% of the data (100/5 = 20). The lowest 20%, from 0 to 20%, is 0.04 to 0.18. The highest 20%, from 80 to 100%, is from 0.49 to 4.81. 
